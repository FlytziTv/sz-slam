      ...
      <main className="flex flex-col gap-8 max-w-340 mx-auto items-center justify-center my-6 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-full">
          ...
          <div className="flex flex-col gap-4 p-4 bg-[#0A0A0A] border border-[#252525] rounded-xl col-span-1 lg:col-span-2">
            <h1 className="text-2xl font-bold uppercase fke">Bts sio <span className="text-lg"> (Services Informatiques aux Organisations)</span></h1>
          ...
          {options.map((item) => (
            <div key={item.name} className="flex flex-col gap-4 p-4 bg-[#0A0A0A] border border-[#252525] rounded-xl">
              <div className="flex flex-row gap-4">
