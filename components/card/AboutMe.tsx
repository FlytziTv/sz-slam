...
export default function AboutMe() {
  return (
    <div className="group relative bg-card w-full border border-border rounded-md grid grid-cols-1 md:grid-cols-3">
      <div className="flex flex-col gap-4 items-start p-4 border-b md:border-0 md:border-r border-border">
      ...
      <div className="flex flex-col gap-4 p-4 border-b md:border-r md:border-0 border-border">
